    ...
    public static void printDayName(int day) {
        ...
        public static void printMonthName(int month) {
            switch (month){
                ...
                case 12: {System.out.print("Decemeber"); break;}

                default: System.out.printf("invalid day (%d)", month);
        }}

            public static void printNmberEnding(int n){

                switch (n%10){
                    case 1: {if (n == 11) System.out.print("th");
                                else System.out.print("st");
                    break;
                    }
                    case 2: {if (n == 12) System.out.print("th");
                                else System.out.print("nd");
                                break;
                    }
                    case 3: {if (n == 13) System.out.print("th");
